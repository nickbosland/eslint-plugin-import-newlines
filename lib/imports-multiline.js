...
module.exports = {
  meta: {
    ...
    docs: {
      ...
      url: 'https://github.com/zsoltszavo/eslint-plugin-import-lines',
    },
    fixable: 'whitespace',
    schema: [
      {
    ...
    messages: {
      mustSplit: 'Imports must be broken into multiple lines if there are more than {{maxItems}} elements.',
  ...
  create(context) {
    const maxItems = context.options[0] || 4;
    return {
